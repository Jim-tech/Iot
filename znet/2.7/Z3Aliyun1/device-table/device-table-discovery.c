...
static void newEndpointDiscovered(EmberAfPluginDeviceTableEntry *p_entry)
{
  ...
  extern void emberAfPluginDeviceTableNewEndPointCallback(EmberEUI64 eui64, uint8_t endpoint, uint16_t deviceID);
  emberAfPluginDeviceTableNewEndPointCallback(p_entry->eui64, p_entry->endpoint, p_entry->deviceId);
